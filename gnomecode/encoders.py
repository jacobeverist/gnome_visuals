...
class _EncoderBase:
    ...
    def __init__(self, oob_method="silent"):
        """
        Constructor code
...
class PeriodicCellEncoder(_EncoderBase):
    ...
    def __init__(self, n=1, l=None, lower_bound=0, upper_bound=1, min_period=None, max_period=None, seed=None,
                 **kwargs):
        """
